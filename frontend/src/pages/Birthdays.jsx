...
const styles = {
  ...
  subtitle: { color: "#888888", marginBottom: "2rem" },
  grid: {
    display: "grid",
  ...
  date: { color: "#2d0a4e", marginBottom: "0.5rem" },
  bias: { color: "#888888", fontSize: "0.9rem" },
  wish: { color: "#7c3aed", marginTop: "0.5rem", fontWeight: "bold" },
};