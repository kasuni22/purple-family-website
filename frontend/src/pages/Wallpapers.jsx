...
const styles = {
  ...
  uploadBtn: { padding: "8px 16px", background: "#7c3aed", border: "none",
  ...
  title: { color: "#b39ddb", fontSize: "2rem", marginBottom: "1.5rem" },
  uploadCard: { background: "#2d0a4e", borderRadius: "12px", padding: "1.5rem",
  ...
  filterBtn: { padding: "6px 16px", borderRadius: "20px", color: "white",
    cursor: "pointer", fontSize: "0.9rem" },
  emptyCard: { background: "#2d0a4e", borderRadius: "12px", padding: "3rem",
    textAlign: "center", border: "1px solid #7c3aed" },
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))",
    gap: "1.5rem" },
  card: { background: "#2d0a4e", borderRadius: "12px", overflow: "hidden",
    border: "1px solid #7c3aed" },
  image: { width: "100%", height: "200px", objectFit: "cover" },
  cardInfo: { padding: "1rem" },
  cardTitle: { color: "#b39ddb", margin: "0 0 0.5rem" },
  member: { color: "#ccc", fontSize: "0.9rem", margin: "0 0 0.5rem" },
  downloadBtn: { display: "inline-block", padding: "6px 16px", background: "#7c3aed",
    color: "white", borderRadius: "6px", textDecoration: "none", fontSize: "0.9rem" }
};