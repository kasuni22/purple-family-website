...
const styles = {
  ...
  addBtn: { padding: "8px 16px", background: "#7c3aed", border: "none",
  ...
  content: { maxWidth: "1200px", margin: "2rem auto", padding: "0 1rem" },
  title: { color: "#2d0a4e", fontSize: "2rem", marginBottom: "0.5rem" },
  subtitle: { color: "#7c3aed", marginBottom: "1.5rem" },
  formCard: { background: "white", borderRadius: "12px", padding: "1.5rem",
  ...
  textarea: { padding: "12px", borderRadius: "8px", border: "1px solid #d4b8ff",
  ...
  emptyCard: { background: "white", borderRadius: "12px", padding: "2rem",
    textAlign: "center", border: "1px solid #d4b8ff" },
  songDetail: { background: "white", borderRadius: "12px", padding: "1.5rem",
  ...
  lyricsBox: { background: "#f8f5ff", borderRadius: "10px", padding: "1.5rem",
    border: "1px solid #e0d0ff" },
  lyricsTitle: { color: "#2d0a4e", marginBottom: "1rem" },
  lyrics: { color: "#2d0a4e", lineHeight: 2, fontFamily: "inherit",
    whiteSpace: "pre-wrap", fontSize: "1rem" },
  selectPrompt: { display: "flex", alignItems: "center", justifyContent: "center",
